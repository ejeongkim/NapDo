...
public class RecordItem  {
    ...
    RecordItem() { } ;
    RecordItem(String drivingDistance, String startPoint, String destinationPoint, String drivingDate, Drawable mapView) {
    ...
    public void setDrivingDistance(String drivingDistance) { this.drivingDistance = drivingDistance; }
    ...
    public String getDrivingDistance() { return this.drivingDistance; }
