...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(ExpandableListView listView, int[] reverseSortedPositions);
    }
     ...
     */
    public SwipeDismissListViewTouchListener(ExpandableListView listView, DismissCallbacks callbacks) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                mDownY = 0;
                mDownView = null;
                mDownPosition = ExpandableListView.INVALID_POSITION;
                mSwiping = false;
                break;
            }
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss && mDownPosition != ExpandableListView.INVALID_POSITION) {
                    // dismiss
