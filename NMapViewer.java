...
public class NMapViewer extends NMapActivity {
	...
	public void onLocationChanged(NGeoPoint myLocation){
		NMapPathData pathData = new NMapPathData(10);
		pathData.initPathData();
		//여기에 포인트를 5초마다 GPS값을 받아서 추가 시킨다.
	...
	private void testMyPathDataOverlay(){
		NMapPathData pathData = new NMapPathData(100000);
	...
	private void testPOIdataOverlay() {
		...
		NMapPOIitem item = poiData.addPOIitem(127.0630205, 50.5091300, "Pizza 777-111", markerId, 0);
